/** Usage:
  ...
  * 
  * Use 'q' to quit and display the number of files saved to each directory.
  *
  * WARNING: be sure to use the data before your next use of this program as it will overwrite the files with the same filenames.
  */
